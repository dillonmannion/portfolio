...
- **AgentTerminal** — `src/components/lab/agent-terminal.tsx`
- **GenreClassifier** — `src/components/lab/genre-classifier.tsx`
- **NixTree** — `src/components/lab/nix-tree.tsx`
- **PrimateChart** — `src/components/lab/primate-chart.tsx`
- **LabCard** — props: title, description, technologies, links — `src/components/lab-card.tsx`
- **BlurFadeText** — props: text, className, variant, hidden — `src/components/magicui/blur-fade-text.tsx`
- **BlurFade** — props: className, variant, hidden — `src/components/magicui/blur-fade.tsx`
- **DEFAULT_MAGNIFICATION** — props: className, magnification, distance — `src/components/magicui/dock.tsx`
